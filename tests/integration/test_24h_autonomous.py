...
class Test24HourAutonomous(unittest.TestCase):
    ...
    def test_1_us_market_hours_trading(self):
        ...
        with patch("src.utils.market_calendar.MarketCalendar.get_active_markets") as mock_active:
            ...
            selected_market = self.rotation.select_active_market(
                target_markets=["US_EQUITY", "CRYPTO"], consider_performance=False
            )
    ...
    def test_6_performance_based_market_selection(self):
        ...
        for i in range(10):
            self.rotation.update_market_performance(
                "CRYPTO",
                {
                    "success": True,
                    "profit": 200.0,
        ...
        self.assertGreater(crypto_score, equity_score, "CRYPTO should have higher score with 100% win rate vs 0%")
        ...
        with patch("src.utils.market_calendar.MarketCalendar.get_active_markets") as mock_active:
            ...
            selected = self.rotation.select_active_market(
                target_markets=["US_EQUITY", "CRYPTO"], consider_performance=True
            )
    ...
    def test_7_state_recovery_after_failure(self):
        ...
        self.assertEqual(stats_after["rotation_count"], rotation_count_before, "Rotation count should be preserved")
        self.assertEqual(
            stats_after["markets"]["US_EQUITY"]["trades"], trades_before, "Trade count should be preserved"
        )
...
class TestLongRunningOperations(unittest.TestCase):
    ...
    def test_2_performance_tracking_scale(self):
        ...
        for i in range(1000):
            rotation.update_market_performance(
                "US_EQUITY",
                {
