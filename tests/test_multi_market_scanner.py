...
def test_fetch_crypto_data():
    ...
    data = market_scan_tools.fetch_universe_data(
        symbols=crypto_symbols, timeframe="1Hour", limit=24, asset_class="CRYPTO"  # Last 24 hours
    )
...
def test_fetch_equity_data():
    ...
    data = market_scan_tools.fetch_universe_data(
        symbols=equity_symbols, timeframe="1Day", limit=30, asset_class="US_EQUITY"  # Last 30 days
    )
...
def test_auto_detect_asset_class():
    ...
    data = market_scan_tools.fetch_universe_data(
        symbols=mixed_symbols, timeframe="1Hour", limit=10, asset_class=None  # Auto-detect
    )
...
def test_analyze_volatility():
    ...
    data = market_scan_tools.fetch_universe_data(
        symbols=crypto_symbols, timeframe="1Day", limit=100, asset_class="CRYPTO"
    )
...
def test_filter_by_liquidity():
    ...
    data = market_scan_tools.fetch_universe_data(
        symbols=crypto_symbols, timeframe="1Day", limit=30, asset_class="CRYPTO"
    )
