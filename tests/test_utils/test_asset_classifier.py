...
class TestAssetClassifier:
    ...
    # Invalid symbols
    INVALID_SYMBOLS = ["", "   ", "123", "TOOLONG", "A1B2C3", "BTC-USD", "BTC_USD", "?AAPL", "AAPL!", "A/B", "@#$%"]
    ...
    def test_whitespace_handling(self):
        ...
        test_cases = [("  AAPL  ", "US_EQUITY"), (" BTC/USD ", "CRYPTO"), ("  EUR/USD  ", "FOREX")]
        for symbol, expected_type in test_cases:
            result = AssetClassifier.classify(symbol)
            assert result["type"] == expected_type
    ...
    def test_result_structure(self):
        ...
        required_fields = ["type", "symbol", "client_type", "markets", "trading_hours", "description"]
    ...
    def test_total_coverage(self):
        ...
        assert len(unique_symbols) >= 50, f"Only testing {len(unique_symbols)} symbols, need 50+"
